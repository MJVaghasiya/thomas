...
import MadhyaPradeshPackage from './MadhyaPradeshPackage';
import Footer from './Footer';

const MadhyaPradeshHome = () => {
  return (
    <div>
        <RNavbar/>
...
<h6 className='container name '  >Most Popular MadhyaPradesh Tour Packages</h6>
<div className='container'>


<table style={{ width: "100%", textAlign: "left", border: "1px solid grey " }}>
    <tr className='package-table color '>
        <th style={{ color: "white", paddingLeft: "17px" }} >MadhyaPradesh Tour Packages	</th>
...
<SearchDes/>
<MadhyaPradeshPackage/>
<Footer/>
    </div>
  )
}

export default MadhyaPradeshHome
