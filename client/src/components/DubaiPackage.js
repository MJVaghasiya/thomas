...
import img1 from '../img/1st-d-package.jpeg';
import img2 from '../img/2nd-d-package.jpeg';
import img3 from '../img/3rd-d-package.jpeg';
import img4 from '../img/4th-d-packae.jpeg';
import img5 from '../img/5th-d-package.jpeg';
import img6 from '../img/6th-d-package.jpeg';
import img7 from '../img/7th-d-package.jpeg';
...
import img15 from '../img/8th-d-package.jpg'
        ...
        <div className='container'>
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px", marginTop: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img8} style={{ marginRight: "12px" }} />
                                Dubai Fully Loaded - Buy 1 Get 1 Free (Deir...
                                </td>
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img8} style={{ marginRight: "12px" }} />
                                Dubai Fully Loaded - Buy 1 Get 1 Free (Al Jad..
                                </td>
                                <td className='right-td' >
                                    4 Nights 5 Days
                                    </td>
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img8} style={{ marginRight: "12px" }} />
                                Dubai Fully Loaded - Buy 1 Get 1 Free (Bur Dub...
                                      </td>
                                <td className='right-td' >
                                    4 Nights 5 Days
                                    </td>
                            ...
                            <tr className='second-tr' >
                                <td className='path-td' >
                                    ...
                                    Dubai (4N)→
                                    <MdFlightTakeoff className='right-plane-icon' />
                                    </td>
                            </tr>
                            <tr className='down-tr' >
                                <td className='custom-td' >Customized Holidays
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img8} style={{ marginRight: "12px" }} />
                                Dubai Fully Loaded - Buy 1 Get 1 Free (Jume...
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img8} style={{ marginRight: "12px" }} />
                                Dubai Fully Loaded - Buy 1 Get 1 Free (Al Bar...
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img8} style={{ marginRight: "12px" }} />
                                Abu Dhabi Fully Loaded (Split Stay ) - Buy 1 G...
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img8} style={{ marginRight: "12px" }} />
                                Abu Dhabi Fully Loaded - Buy 1 Get 1 Free
