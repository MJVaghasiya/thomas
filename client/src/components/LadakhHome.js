...
import LadakhPackage from './LadakhPackage';
...
<h6 className='container name '  >Most Popular Ladakh Tour Packages</h6>
<div className='container'>


<table style={{ width: "100%", textAlign: "left", border: "1px solid grey " }}>
    <tr className='package-table color '>
        <th style={{ color: "white", paddingLeft: "17px" }} >Ladakh Tour Packages	</th>
