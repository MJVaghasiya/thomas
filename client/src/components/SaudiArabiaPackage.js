...
import img1 from '../img/1st-sa-package.jpeg';
import img2 from '../img/2nd-sa-package.jpeg';
import img3 from '../img/3rd-sa-package.jpeg';
import img4 from '../img/4th-sa-package.jpeg';
import img5 from '../img/5th-sa-package.jpeg';
import img6 from '../img/6th-sa-package.jpeg';
import img7 from '../img/7th-sa-package.jpeg';
import img8 from '../img/8th-sa-package.jpeg'
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img9} style={{ marginRight: "12px" }} />
                                Discover AlUla With Hegra And Elephant Rock
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img9} style={{ marginRight: "12px" }} />
                                Discover AlUla With Hegra And Stargazing
                ...
                <table style={{ width: "100%", height: "254px", position: "relative", left: "-27px", marginBottom: "20px" }}>
                    <tr className='first-tr' >
                        ...
                        <td className='mid-td' >
                            <tr className='up-tr' >
                                <td className='left-td' ><img src={img9} style={{ marginRight: "12px" }} />
                                Glimpse of Saudi Arabia Riyadh and Jeddah
</td>
                                <td className='right-td' >
                                4 Nights 5 Days
                                    </td>
...
export default SaudiArabiaPackage
